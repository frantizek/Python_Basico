...
def main():
    ...
    #         print(f"cd into directory day{str(practice).zfill(2)}!")
    #
    #         for practice_num in range(1, 4):
    #             with open(f"day{str(practice).zfill(2)}_exercise{str(practice_num).zfill(2)}.py", 'w') as document:
    #                 pass
    #
